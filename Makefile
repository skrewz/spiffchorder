...
# $Id:: Makefile 26 2012-01-22 18:27:08Z spacemanspiff                $ #
# Version 0.98                                                          #
#########################################################################
# SpiffChorder is Copyright (C) 2006-2012 Mikkel Holm Olsen base on     #
# HID-Test by Christian Starkjohann, Objective Development              #
#########################################################################
...
main.o : main.c Makefile
	@echo
	@echo $(MSG_COMPILING) $<
	$(CC) -c $(ALL_CFLAGS) $< -o $@ -Ikeymaps/ -include $(KEYMAP)
